...
$jscomp.iteratorPrototype=function(g){$jscomp.initSymbolIterator();g={next:g};g[$jscomp.global.Symbol.iterator]=function(){return this};return g};$jscomp.iteratorFromArray=function(g,t){$jscomp.initSymbolIterator();g instanceof String&&(g+="");var v=0,p={next:function(){if(v<g.length){var B=v++;return{value:t(B,g[B]),done:!1}}p.next=function(){return{done:!0,value:void 0}};return p.next()}};p[Symbol.iterator]=function(){return p};return p};
$jscomp.polyfill=function(g,t,v,p){if(t){v=$jscomp.global;g=g.split(".");for(p=0;p<g.length-1;p++){var B=g[p];B in v||(v[B]={});v=v[B]}g=g[g.length-1];p=v[g];t=t(p);t!=p&&null!=t&&$jscomp.defineProperty(v,g,{configurable:!0,writable:!0,value:t})}};$jscomp.polyfill("Array.prototype.keys",function(g){return g?g:function(){return $jscomp.iteratorFromArray(this,function(g){return g})}},"es6","es3");
function dv_baseHandler(){function g(a){var b=window._dv_win,e=0;try{for(;10>e;){if(b[a]&&"object"===typeof b[a])return!0;if(b==b.parent)break;e++;b=b.parent}}catch(d){}return!1}function t(a){var b=0,e;for(e in a)a.hasOwnProperty(e)&&++b;return b}function v(a,b){a:{var e={};try{if(a&&a.performance&&a.performance.getEntries){var d=a.performance.getEntries();for(a=0;a<d.length;a++){var c=d[a],m=c.name.match(/.*\/(.+?)\./);if(m&&m[1]){var f=m[1].replace(/\d+$/,""),h=b[f];if(h){for(var g=0;g<h.stats.length;g++){var r=
h.stats[g];e[h.prefix+r.prefix]=Math.round(c[r.name])}delete b[f];if(!t(b))break}}}}var n=e;break a}catch(C){}n=void 0}if(n&&t(n))return n}function p(a,b){function e(a){var c=r,b;for(b in a)a.hasOwnProperty(b)&&(c+=["&"+b,"="+a[b]].join(""));return c}function d(){return Date.now?Date.now():(new Date).getTime()}function c(){if(!t){t=!0;var c=e({dvp_injd:1});$dvbs.domUtilities.addImage(c,document.body);try{c="https://cdn.doubleverify.com/dvtp_src.js#tagtype=video";for(var b="ctx cmp plc sid adsrv adid crt advid prr dup turl iframe ad vssd apifw vstvr tvcp ppid auip pltfrm gdpr gdpr_consent adu invs litm ord sadv scrt vidreg seltag splc spos sup unit dvtagver msrapi vfwctx auprice audeal auevent auadv aucmp aucrtv auorder ausite auplc auxch audvc aulitem auadid autt c1 c2 c3 c4 c5 c6 c7 c8 c9 c10 c11 c12 c13 c14 c15 aufilter1 aufilter2 ppid".split(" "),
f=0;f<b.length;f++){var m=b[f],n=h(a,m);void 0!==n&&(c+=["&",m,"=",encodeURIComponent(n)].join(""))}c+="&gmnpo="+("1"==a.gmnpo?"1":"0");c+="&dvp_dvtpts="+d();c+="&bsimpid="+g;void 0!==a.dvp_aubndl&&(c+="&aubndl="+encodeURIComponent(a.dvp_aubndl));for(var l in a)a.hasOwnProperty(l)&&l.match(/^(dvp|dvpx|tde)_/i)&&a[l]&&(c+=["&",l.toLocaleLowerCase(),"=",encodeURIComponent(a[l])].join(""));$dvbs.domUtilities.addScriptResource(c,document.body)}catch(M){m=e({dvp_innovidCallbackEx:4,dvp_innovidCallbackExMsg:M}),
$dvbs.domUtilities.addImage(m,document.body)}}}function m(a){var c={};c[a]=d();a=e(c);$dvbs.domUtilities.addImage(a,document.body)}function f(a,c){-1<k.indexOf(a)?m(c):p.subscribe(function(){m(c)},a)}function h(a,c){c=c.toLowerCase();for(var b in a)if(b.toLowerCase()===c)return a[b];return null}var g=a.impressionId,r=window._dv_win.dv_config.bsEventJSURL?window._dv_win.dv_config.bsEventJSURL:"https://"+a.ServerPublicDns+"/bsevent.gif";r+="?flvr=0&impid="+encodeURIComponent(g);var n=e({dvp_innovidImp:1}),
C="responseReceived_"+g,u=a.DVP_DCB||a.DVP_DECISION_CALLBACK,l=h(a,"adid"),q=function(a){var c=a;switch(a){case 5:c=1;break;case 6:c=2}return c}(b.ResultID),t=!1;$dvbs.domUtilities.addImage(n,document.body);if("function"===typeof window[u]){var x=!1;setTimeout(function(){var a=e({dvp_wasCallbackCalled:x});$dvbs.domUtilities.addImage(a,document.body)},1E3);window[C]=function(a,b,f,m,n,h,l){x=!0;try{if(l){var k=e({dvp_stat:l});$dvbs.domUtilities.addImage(k,document.body)}else{k=e({dvp_r9:d()});$dvbs.domUtilities.addImage(k,
document.body);f="&dvp_cStartTS="+f+"&dvp_cEndTS="+m+"&dvp_dReceivedTS="+n+"&dvp_wasAdPlayed="+a;m=q;if(!b)switch(m=2,q){case 1:var g=21;break;case 2:g=20;break;case 3:g=22;break;case 4:g=23}b={bres:m,dvp_blkDecUsed:b?"1":"0"};g&&(b.breason=g);k=e(b)+f;$dvbs.domUtilities.addImage(k,document.body,h);a&&!H()&&c()}}catch(N){a=e({dvp_innovidCallbackEx:1,dvp_innovidCallbackExMsg:N}),$dvbs.domUtilities.addImage(a,document.body)}};try{var y=e({dvp_r8:d()});$dvbs.domUtilities.addImage(y,document.body);window[u](q,
C)}catch(D){b=e({dvp_innovidEx:1,dvp_innovidExMsg:D}),$dvbs.domUtilities.addImage(b,document.body)}}else b=e({dvp_innovidNoCallback:1}),$dvbs.domUtilities.addImage(b,document.body);try{var p=window[l]();if(p.getPreviousEvents&&"function"===typeof p.getPreviousEvents){y=e({dvp_r10:d()});$dvbs.domUtilities.addImage(y,document.body);var k=p.getPreviousEvents(),w=0;-1<k.indexOf("AdStarted")?(w=1,c()):p.subscribe(c,"AdStarted");y=e({dvp_innovidAdStarted:w,dvp_innovidPrevEvents:k});$dvbs.domUtilities.addImage(y,
document.body);f("AdError","dvp_ader");f("AdStopped","dvp_adst");f("AdVideoStart","dvp_avse");f("AdImpression","dvp_aie")}else w=e({dvp_innovidCallbackEx:3,dvp_innovidCallbackExMsg:"vpaidWrapper.getPreviousEvents not a function"}),$dvbs.domUtilities.addImage(w,document.body)}catch(D){w=e({dvp_innovidCallbackEx:2,dvp_innovidCallbackExMsg:D,dvp_adid:l,dvp_adidt:typeof window[l]}),$dvbs.domUtilities.addImage(w,document.body)}}function B(a,b){try{$dvbs.registerEventCall(a,{dvp_te_exec:O.RTN}),Object.keys(b).length&&
b.forEach(function(b){b.actions&&b.actions.length?b.actions.forEach(function(d){$dvbs.pubSub.subscribe(b.eventName,a,"RTN_"+b.eventName,function(){d.url&&d.actionType&&("image"===d.actionType?navigator.sendBeacon(d.url):"javascript"===d.actionType&&$dvbs.domUtilities.addScriptResource(d.url,document.body))})}):$dvbs.registerEventCall(a,{dvp_rtnError:1,dvp_errMsg:"Malformed or empty RTN object"})})}catch(e){$dvbs.registerEventCall(a,{dvp_rtnError:1,dvp_errMsg:encodeURIComponent(e.message)})}}function P(a){var b,
e=window._dv_win.document.visibilityState;window[a.tagObjectCallbackName]=function(d){var c=window._dv_win.$dvbs;c&&(b=d.ImpressionID,c.tags.add(d.ImpressionID,a),c.tags[d.ImpressionID].set({tagElement:a.script,impressionId:d.ImpressionID,dv_protocol:a.protocol,protocol:"https:",uid:a.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns}),a.script&&a.script.dvFrmWin&&(a.script.dvFrmWin.$uid=d.ImpressionID,c.messages&&c.messages.startSendingEvents&&c.messages.startSendingEvents(a.script.dvFrmWin,
d.ImpressionID)),function(){function a(){"prerender"===e&&"prerender"!==c&&"unloaded"!==c&&(e=c,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(b,a))}var c=window._dv_win.document.visibilityState;if("prerender"===e)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==c)window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0});else{var b;"undefined"!==typeof window._dv_win.document.hidden?b="visibilitychange":"undefined"!==
typeof window._dv_win.document.mozHidden?b="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?b="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(b="webkitvisibilitychange");window._dv_win.document.addEventListener(b,a,!1)}}());if("1"!=a.foie)try{var m=v(window,{verify:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});m&&window._dv_win.$dvbs.registerEventCall(d.ImpressionID,m)}catch(f){}};window[a.callbackName]=function(d){z.setIsJSONPCalled(!0);
var c=window._dv_win.$dvbs&&"object"==typeof window._dv_win.$dvbs.tags[b]?window._dv_win.$dvbs.tags[b]:a;var e=window._dv_win.dv_config.bs_renderingMethod||function(a){document.write(a)};"2"!=c.tagformat||void 0===c.DVP_DCB&&void 0===c.DVP_DECISION_CALLBACK||p(c,d);switch(d.ResultID){case 1:c.tagPassback?e(c.tagPassback):d.Passback?e(decodeURIComponent(d.Passback)):d.AdWidth&&d.AdHeight&&e(decodeURIComponent("%3Cdiv%20style%3D%22display%3A%20flex%3B%20align-items%3A%20center%3B%20justify-content%3A%20center%3B%20width%3A%20"+
d.AdWidth+"px%3B%20height%3A%20"+d.AdHeight+"px%3B%20outline-offset%3A%20-1px%3B%20background%3A%20url('data%3Aimage%2Fpng%3Bbase64%2CiVBORw0KGgoAAAANSUhEUgAAADoAAAA6CAYAAAGWvHq%2BAAAABmJLR0QA%2FwD%2FAP%2BgvaeTAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAB3RJTUUH5AQBECEbFuFN7gAAAB1pVFh0Q29tbWVudAAAAAAAQ3JlYXRlZCB3aXRoIEdJTVBkLmUHAAAFBklEQVRo3uUby3arOEzxAbxIyKLt%2F%2F9gIQtIF4aFZ5ERVxhJyIbcnjmjTZLast4vQ%2BG762OMMX53fQzTFIfxGenfKvgXvj4%2FoOsfy3eECgBgmmcYhnFZ6PoHeO%2F%2FbBiGEQAAxufPghlC%2BLOBYqa%2FHezAJcYYOUz87QAA7vd2g4lMAsrLfQJ%2BQeUM43PZsMJEwN8L58gMfgIAAMVKv6syX4bxGVF9qTiuvV2Byouf7e0Kl%2B%2Buj6kJU8aktV07aFClTkThfm9hGMbNGu53dCNd%2FPr8gBCm5TsnAivz%2BPwBqkHvPaDiVvpAW6Nh0FBhmpagSdfQV0Q7oVySPrz3LyO3t%2BvCKrJIHTtdG58%2FvLycZk%2Bzr1uFkgFWuYHKZHHNEMIr4lMb0pO5v7e3qyyj983KATYydv1jswFZneZ5wzaKVaEMVnNgjsw2B8pcbMdLmKbY1PVG5dTl0rVpnsGlSDReOcfo%2Bgc0df3SagrTPC8m4aDrH1ClaR4AgHKRmgN%2FL9HBbeI4wdKVitXUtYpLGXPSgpUg1lBaPzWCWW6wJ4lkB9aFUL1pQkXOvW9WBDltULNM8wwhTEtIcQn88t31kdpEU7FmOwsemqiiqtPsQvufXMCmCulUSKy9XaG9XYGrLhbv1iSlWU0NGdyQqlPKBHQfh0vxVkQ1abSQybX3oQ7nUPWUpEQ1oaokLVAnSfG4cy8xxpjrEFyVtuCJNt3rETDgu%2F6xiT9zRqKSci0DxzHdZ5E0zXabjGTtwSxr9FyqjazSJkmTi%2Bckb01BS5HaGnems%2BZWzdb62qQTfQdwDDl2Wj0RuKnYpX1sDrJljcvHTqow4%2FNn5SBNXYuzPD0Y8agDsRlpr3NIg1vyYGnSS%2BPUURVIcRhC2A0ZyYPxTKqNyuo8IYRlpMSGLYRJDRdOYyEEqEpDIIfY5qYhhLBrL0s%2BLS7imqq995tijYVdCxlx0EMnaW9XlvD93m4aZ0s4cZ3gqspYOjppRKcMcXipGZyU7Ju63iXIhVOKx53trCWqtMpwZzor8n%2BqynBnnlJlNGa5M51VSmlksBSDlOHlKk%2FzUq0KcVVEYgidytz3coS19lPrFh1y2fUP1Xu1HKsRxHWakao9hLNglZHeESaal3vvocKx3zKP7BXnLJtaxgNkjKY1Wp1y7inYUVG7Akg79vSeKefKwHJ1kEtTikBxJrYkmpIBr1TgPdgbrZ1WkPbuz84UEiNZG1ZLhdydE0sqeqlytGG2pEt4%2B0Ccc9H8zs4kS1Br0542F0fqR0lesOCwyehoIioZq86gqcWq6XbZwrTGqMSAhmOhKWVpjp74PObIsLt3R3g0g1oETs8R32woFbLEHUuEs9CiZa6SslZJmpcuf%2F4GcNc0tDf9lYcxvwGVrI3mkDVeY0NjbumOui9XCtkYlZJIbjt3pF8tzQ0czZTvTXnJSdlHSstRXAlPUpQ4vRy1TK4nnNEwaDTd2ZNE6fQSQiieevBiprjXLamjpco5Mv1YSuH%2Fpry4o%2BMPN70cgZI4tYyG7h3J4evzI1tJ%2BIynBLTHMdnlpXQKsTQCkoAaPakZEctL%2BpbK0Y7FMkloCnrXHMsKileMpS0ZR3zvveez2kDJG6szRiSuJqaulfbOaQJ5KfcYH5wnLK82v2uMCmHaPDz%2BDVj%2BfSNNBGdZmIu9v6EIKWbVZHTmVYrl9clSRVsS0urOKDdlW1J%2B6SubFoH3SiF13X8A3uobUgsAG3MAAAAASUVORK5CYII%3D')%20repeat%3B%20outline%3A%20solid%201px%20%23969696%3B%22%3E%3C%2Fdiv%3E"));
...
d.ServerContext.rtn&&d.ServerContext.rtn.events&&B(b,d.ServerContext.rtn.events)}}function Q(a){var b=null,e=null,d=function(a){var c=dv_GetParam(a,"cmp");a=dv_GetParam(a,"ctx");return"919838"==a&&"7951767"==c||"919839"==a&&"7939985"==c||"971108"==a&&"7900229"==c||"971108"==a&&"7951940"==c?"</scr'+'ipt>":/<\/scr\+ipt>/g}(a.src);"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var c=function(a){!(a=a.previousSibling)||"#text"!=a.nodeName||
...
e=a.innerHTML.replace(d,"\x3c/script>");a=c(a);a.hasPassback=!0;return a}return{isBadImp:!0,hasPassback:!1,tagAdTag:b,tagPassback:e}};return c(a)}function H(){try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv)return 1}catch(a){}return 0}function I(a,b,e,d,c,m,f,h,t,r,n,C){b.dvregion=0;var u=dv_GetParam(k,"useragent");k=window._dv_win.$dvbs.CommonData;if(void 0!=k.BrowserId&&void 0!=k.BrowserVersion&&void 0!=k.BrowserIdFromUserAgent)var l={ID:k.BrowserId,version:k.BrowserVersion,
ID_UA:k.BrowserIdFromUserAgent};else l=R(u?decodeURIComponent(u):navigator.userAgent),k.BrowserId=l.ID,k.BrowserVersion=l.version,k.BrowserIdFromUserAgent=l.ID_UA;var q="";void 0!=b.aUrl&&(q="&aUrl="+b.aUrl);var p="";try{d.depth=S(d);var x=T(d,e,l);if(x&&x.duration){var y="&dvp_strhd="+x.duration;y+="&dvpx_strhd="+x.duration}x&&x.url||(x=U(d));x&&x.url&&(q="&aUrl="+encodeURIComponent(x.url),p="&aUrlD="+x.depth);var v=d.depth+c;m&&d.depth--}catch(D){y=p=q=v=d.depth=""}c=H();m=function(){function a(c){b++;
var d=c.parent==c;return c.mraid||d?c.mraid:20>=b&&a(c.parent)}var c=window._dv_win||window,b=0;try{return a(c)}catch(fa){}}();var k=b.script.src;c="&ctx="+(dv_GetParam(k,"ctx")||"")+"&cmp="+(dv_GetParam(k,"cmp")||"")+"&plc="+(dv_GetParam(k,"plc")||"")+"&sid="+(dv_GetParam(k,"sid")||"")+"&advid="+(dv_GetParam(k,"advid")||"")+"&adsrv="+(dv_GetParam(k,"adsrv")||"")+"&unit="+(dv_GetParam(k,"unit")||"")+"&isdvvid="+(dv_GetParam(k,"isdvvid")||"")+"&uid="+b.uid+"&tagtype="+(dv_GetParam(k,"tagtype")||"")+
"&adID="+(dv_GetParam(k,"adID")||"")+"&app="+(dv_GetParam(k,"app")||"")+"&sup="+(dv_GetParam(k,"sup")||"")+"&isovv="+c+"&gmnpo="+(dv_GetParam(k,"gmnpo")||"")+"&crt="+(dv_GetParam(k,"crt")||"");"1"==dv_GetParam(k,"foie")&&(c+="&foie=1");m&&(c+="&ismraid=1");(m=dv_GetParam(k,"xff"))&&(c+="&xff="+m);(m=dv_GetParam(k,"vssd"))&&(c+="&vssd="+m);(m=dv_GetParam(k,"apifw"))&&(c+="&apifw="+m);(m=dv_GetParam(k,"vstvr"))&&(c+="&vstvr="+m);(m=dv_GetParam(k,"tvcp"))&&(c+="&tvcp="+m);n&&(c+="&urlsrc=sf");C&&(c+=
"&sfe=1");navigator&&navigator.maxTouchPoints&&5==navigator.maxTouchPoints&&(c+="&touch=1");navigator&&navigator.platform&&(c+="&nav_pltfrm="+navigator.platform);y&&(c+=y);u&&(c+="&useragent="+u);l&&(c+="&brid="+l.ID+"&brver="+l.version+"&bridua="+l.ID_UA);c+="&dup="+dv_GetParam(k,"dup");try{c+=dv_AppendIQPAParams(k)}catch(D){}(n=dv_GetParam(k,"turl"))&&(c+="&turl="+n);(n=dv_GetParam(k,"tagformat"))&&(c+="&tagformat="+n);"video"===dv_GetParam(k,"tagtype")&&(c+="&DVP_BYPASS219=1");c+=V();r=r?"&dvf=0":
"";n=g("maple")?"&dvf=1":"";f=(window._dv_win.dv_config.verifyJSURL||"https://"+(window._dv_win.dv_config.bsAddress||"rtb"+b.dvregion+".doubleverify.com")+"/verify.js")+"?flvr=0&jsCallback="+b.callbackName+"&jsTagObjCallback="+b.tagObjectCallbackName+"&num=6"+c+"&srcurlD="+d.depth+"&ssl="+b.ssl+r+n+"&refD="+v+b.tagIntegrityFlag+b.tagHasPassbackFlag+"&htmlmsging="+(f?"1":"0")+"&tstype="+J(window._dv_win);(v=dv_GetDynamicParams(k,"dvp").join("&"))&&(f+="&"+v);(v=dv_GetDynamicParams(k,"dvpx").join("&"))&&
(f+="&"+v);if(!1===h||t)f=f+("&dvp_isBodyExistOnLoad="+(h?"1":"0"))+("&dvp_isOnHead="+(t?"1":"0"));e="srcurl="+encodeURIComponent(e);(h=W())&&(e+="&ancChain="+encodeURIComponent(h));(d=X(d))&&(e+="&canurl"+encodeURIComponent(d));d=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(d=2E3);if(h=dv_GetParam(k,"referrer"))h="&referrer="+h,f.length+h.length<=d&&(f+=h);(h=dv_GetParam(k,"prr"))&&(f+="&prr="+h);(h=dv_GetParam(k,"iframe"))&&(f+="&iframe="+h);(h=dv_GetParam(k,"gdpr"))&&
(f+="&gdpr="+h);(h=dv_GetParam(k,"gdpr_consent"))&&(f+="&gdpr_consent="+h);q.length+p.length+f.length<=d&&(f+=p,e+=q);(q=Y())&&(f+="&m1="+q);(q=Z())&&0<q.f&&(f+="&bsig="+q.f,f+="&usig="+q.s);q=aa();0<q&&(f+="&hdsig="+q);navigator&&navigator.hardwareConcurrency&&(f+="&noc="+navigator.hardwareConcurrency);f+=ba();q=ca();f+="&vavbkt="+q.vdcd;f+="&lvvn="+q.vdcv;""!=q.err&&(f+="&dvp_idcerr="+encodeURIComponent(q.err));"prerender"===window._dv_win.document.visibilityState&&(f+="&prndr=1");(k=dv_GetParam(k,
...
err:void 0}}catch(c){return{vdcv:28,vdcd:"-999",err:c.message||"unknown"}}}function S(a){for(var b=0;10>b&&a!=window._dv_win.top;)b++,a=a.parent;return b}function J(a){if(a==window._dv_win.top)return $dvbs.Enums.TrafficScenario.OnPage;try{for(var b=0;window._dv_win.top!=a&&10>=b;){var e=a.parent;if(!e.document)break;a=e;b++}}catch(d){}return a==window._dv_win.top?$dvbs.Enums.TrafficScenario.SameDomain:$dvbs.Enums.TrafficScenario.CrossDomain}function T(a,b,e){try{if(e.ID==$dvbs.Enums.BrowserId.IE||
J(a)!=$dvbs.Enums.TrafficScenario.CrossDomain)return null;a.performance&&a.performance.mark&&a.performance.mark("dv_str_html_start");if(b){var d=b.toString().match(/^(?:https?:\/\/)?[\w\-\.]+\/[a-zA-Z0-9]/gi);if(d&&0<d.length)return null}var c=a.document;if(c&&c.referrer){var m=c.referrer.replace(/\//g,"\\/").replace(/\./g,"\\."),f=new RegExp('(?:w{0,4}=")?'+m+"[^&\"; %,'\\$\\\\\\|]+","gi");b=/banner|adprefs|safeframe|sandbox|sf\.html/gi;e=/^\w{0,4}="/gi;var h=K(c,"script","src",f,b,e);if(!h){var g=
c.referrer;d="";var r=c.getElementsByTagName("script");if(r)for(m=0;!d&&m<r.length;){var n=r[m].innerHTML;if(n&&-1!=n.indexOf(g)){var C=n.match(f);d=L(C,b,e)}m++}(h=d)||(h=K(c,"a","href",f,b,e))}var u=h;a:{if(a.performance&&a.performance.mark&&a.performance.measure&&a.performance.getEntriesByName){a.performance.mark("dv_str_html_end");a.performance.measure("dv_str_html","dv_str_html_start","dv_str_html_end");var l=a.performance.getEntriesByName("dv_str_html");if(l&&0<l.length){var q=l[0].duration.toFixed(2);
break a}}q=null}return{url:u,depth:-1,duration:q}}}catch(ea){}return null}function L(a,b,e){var d="";if(a&&0<a.length)for(var c=0;c<a.length;c++){var g=a[c];g.length>d.length&&null==g.match(b)&&0!=g.indexOf('src="')&&0!=g.indexOf('turl="')&&(d=g.replace(e,""))}return d}function K(a,b,e,d,c,g){a=a.querySelectorAll(b+"["+e+'*="'+a.referrer+'"]');var f="";if(a)for(b=0;!f&&b<a.length;)f=a[b][e].match(d),f=L(f,c,g),b++;return f}function U(a){try{if(1>=a.depth)return{url:"",depth:""};var b=[];b.push({win:window._dv_win.top,
depth:0});for(var e,d=1,c=0;0<d&&100>c;){try{if(c++,e=b.shift(),d--,0<e.win.location.toString().length&&e.win!=a)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,depth:e.depth-1}}catch(h){}var g=e.win.frames.length;for(var f=0;f<g;f++)b.push({win:e.win.frames[f],depth:e.depth+1}),d++}return{url:"",depth:""}}catch(h){return{url:"",depth:""}}}function W(){var a=window._dv_win[E("=@42E:@?")][E("2?46DE@C~C:8:?D")];if(a&&0<a.length){var b=
[];b[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<a.length;e++)b[e+1]=a[e];return b.reverse().join(",")}return null}function X(a){return(a=a.document.querySelector("link[rel=canonical]"))?a.href:null}function E(a){new String;var b=new String,e;for(e=0;e<a.length;e++){var d=a.charAt(e);var c="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(d);0<=c&&(d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((c+
47)%94));b+=d}return b}function F(){return Math.floor(1E12*(Math.random()+""))}function R(a){for(var b=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",verRegex:"(MSIE |rv:| Edge/|Edg/)"},{id:2,brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",verRegex:null},{id:0,brRegex:"AOL/.*AOLBuild/|AOLBuild/.*AOL/|Puffin|Maxthon|Valve|Silk|PLAYSTATION|PlayStation|Nintendo|wOSBrowser",
verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}],e=0,d="",c=0;c<b.length;c++)if(null!=a.match(new RegExp(b[c].brRegex))){e=b[c].id;if(null==b[c].verRegex)break;a=a.match(new RegExp(b[c].verRegex+"[0-9]*"));null!=a&&(d=a[0].match(new RegExp(b[c].verRegex)),d=a[0].replace(d[0],""));break}b=da();4==e&&(b=e);return{ID:b,version:b===e?d:"",ID_UA:e}}function da(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;
...
window.webkitConvertPointFromNodeToPage)&&a&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(e){return 0}}function Y(){try{var a=0,b=function(b,c){c&&32>b&&(a=(a|1<<b)>>>0)},e=function(a,b){return function(){return a.apply(b,arguments)}},d="svg"===document.documentElement.nodeName.toLowerCase(),c=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):d?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,
arguments)},g=["Moz","O","ms","Webkit"],f=["moz","o","ms","webkit"],h={style:c("modernizr").style},p=function(a,b){function d(a){return a.replace(/([a-z])-([a-z])/g,function(a,b,c){return b+c.toUpperCase()}).replace(/^-/,"")}function e(){n&&(delete h.style,delete h.modElem)}var f;for(f=["modernizr","tspan","samp"];!h.style&&f.length;){var n=!0;h.modElem=c(f.shift());h.style=h.modElem.style}var g=a.length;for(f=0;f<g;f++){var m=a[f];~(""+m).indexOf("-")&&(m=d(m));if(void 0!==h.style[m])return e(),
"pfx"==b?m:!0}e();return!1},r=function(a,b,c){var d=a.charAt(0).toUpperCase()+a.slice(1),n=(a+" "+g.join(d+" ")+d).split(" ");if("string"===typeof b||"undefined"===typeof b)return p(n,b);n=(a+" "+f.join(d+" ")+d).split(" ");for(var h in n)if(n[h]in b){if(!1===c)return n[h];a=b[n[h]];return"function"===typeof a?e(a,c||b):a}return!1};b(0,!0);b(1,r("requestFileSystem",window));b(2,window.CSS?"function"==typeof window.CSS.escape:!1);b(3,r("shapeOutside","content-box",!0));return a}catch(n){return 0}}
function G(){var a=window,b=0;try{for(;a.parent&&a!=a.parent&&a.parent.document&&!(a=a.parent,10<b++););}catch(e){}return a}function Z(){try{var a=G(),b=0,e=0,d=function(a,c,d){d&&(b+=Math.pow(2,a),e+=Math.pow(2,c))},c=a.document;d(14,0,a.playerInstance&&c.querySelector('script[src*="ads-player.com"]'));d(14,1,(a.CustomWLAdServer||a.DbcbdConfig)&&function(){var a=c.querySelector('p[class="footerCopyright"]');return a&&a.textContent.match(/ MangaLife 2016/)}());d(15,2,a.zpz&&a.zpz.createPlayer);d(15,
...
this.onFailure=function(){};var O={RTN:1};window.debugScript&&(window.CreateUrl=I);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"174"}};
